...
namespace GameStore.BLL.Tests.Services
{
    ...
    public class StoreServiceTest
    {
        ...
        public void CreateGame_ValidationExceptionThrown_KeyExists()
        {
            ...
            // Act & Assert
            Assert.Throws<ValidationException>(() => sut.AddOrUpdate(new GameDTO { Key = "stub-key", Name = "stub-name" }, true));
        }
        ...
        public void UpdateGame_ValidationExceptionThrown_KeyExists()
        {
            ...
            // Act & Assert
            Assert.Throws<System.Reflection.TargetInvocationException>(() => sut.AddOrUpdate((new GameDTO { Key = "another-key-that-exists-in-db", Name = "stub-name" }), false));
        }
