...
{
    public class ModelWithKeyService<T, TD> : IWithKeyService<TD> where T: class, IEntityWithKey, new() where TD: class, IDtoWithKey, new()
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly ILogger _logger = LogManager.GetCurrentClassLogger();
        private readonly DtoToDomain _dtoToDomain;

        public ModelWithKeyService(IUnitOfWork unitOfWork)
        {
