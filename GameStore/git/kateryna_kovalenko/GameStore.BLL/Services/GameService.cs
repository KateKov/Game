...
namespace GameStore.BLL.Services
{
    public class GameService : IService
    {
        ...
        public GameService(IUnitOfWork unitOfWork, ILogger logger)
        {
            ...
            _genreRepository = _unitOfWork.GenreRepository;
            _platformTypeRepository = _unitOfWork.PlatformTypeRepository;
        ...
        public void AddGame(GameDTO gameDto)
        {
            ...
            try
            {
                ...
                if (allGenres.Count > 0)
                {
                    ...
                    throw new ValidationException("There are no genres exists", "");
                ...
                if (allPlatforms.Count > 0)
                {
                    ...
                    throw new ValidationException("There are no platforms exists", "");
